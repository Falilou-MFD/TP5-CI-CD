...
pipeline {
    ...
    stages {
        ...
        stage("Checkout") {
            steps {
                git branch: 'master', url: "https://github.com/Falilou-MFD/TP5-CI-CD.git"
            }
        }
